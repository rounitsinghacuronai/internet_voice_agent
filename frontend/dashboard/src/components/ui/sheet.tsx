...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card p-6 shadow-xl transition ease-in-out data-[state=open]:animate-fade-in",
  {
    variants: {
      side: {
        ...
        right: "inset-y-0 right-0 h-full w-[420px] max-w-full border-l",
      },
    },
